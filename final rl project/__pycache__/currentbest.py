...
import threading #maybe use for parrallelizing more code us
import time
import os
...
def build_model(input_shape, n_actions):
   ...
   model.add(Conv2D(16, (8, 8), strides=(4, 4), activation="relu", padding="valid"))
   model.add(Conv2D(32, (4, 4), strides=(2, 2), activation="relu", padding="valid"))
...
def train():
   ...
   online_net.save_weights('models/dqn_weights_final4.weights.h5')
